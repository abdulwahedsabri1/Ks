        ...
        <div className="relative hidden lg:flex flex-col justify-between p-12 overflow-hidden">
          ...
          <div className="relative z-10">
            <Link to="/" className="flex items-center gap-2.5 group">
              <img
                src="/favicon.ico"
                alt="MY Link QR Logo"
                className="size-9 rounded-xl object-contain shadow-md transition-transform group-hover:scale-105 shrink-0"
              />
          ...
          <div className="relative z-10 max-w-md">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#F5A623]/10 border border-[#F5A623]/20 text-[#F5A623] text-xs font-semibold mb-6 shadow-[0_0_15px_rgba(245,166,35,0.2)]"
            >
            ...
            >
              {[
                ...
                <motion.span
                  ...
                  className="px-3 py-1.5 rounded-full bg-white/5 border border-white/10 text-white/60 hover:text-white transition-colors cursor-default text-xs font-medium"
                >
                  {f}
                </motion.span>
              ))}
            ...
            >
              {["R", "P", "S", "A"].map((l, i) => (
                <motion.div
                  ...
                  className="w-8 h-8 rounded-full border-2 border-[#0f0b07] flex items-center justify-center text-xs font-bold text-black shadow-lg"
                  style={{
