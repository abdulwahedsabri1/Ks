...
function AuthPage() {
  ...
  async function handleGoogle() {
    ...
    try {
      ...
      // If no error, the browser will redirect to Google — no need to do anything else
    } catch {
              ...
              {activeTab === "login" ? (
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full h-12 flex items-center justify-center gap-3 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 text-white font-semibold text-sm transition-all hover:border-white/20 active:scale-[0.99]"
                  >
                    {googleLoading ? (
