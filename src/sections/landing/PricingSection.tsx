...
export function PricingSection() {
  ...
  const handleCheckout = (p: PlanItem) => {
    if (!user) {
      navigate({ to: "/auth" });
      return;
    }
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
          ...
          <motion.h2
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="font-display text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight mb-4 text-[#100C09]"
          >
          ...
          <motion.p
            ...
            className="text-base sm:text-lg text-[#3A2818]/70 leading-relaxed font-medium mb-8"
          >
        ...
        {/* Multi-Business Comparison Chart Below Pricing */}
        <div className="mt-24 max-w-5xl mx-auto">
          <MultiBusinessComparisonChart />
        </div>
      </div>

      {/* Inline Payment Modal when choosing a paid plan */}
      {selectedPlan && (
        <RazorpayModal
          plan={selectedPlan}
